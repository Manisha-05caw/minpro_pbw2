...
--
-- Host: localhost:3306
-- Generation Time: Mar 27, 2026 at 12:34 PM
...
(1, 'Syawe Manisha P. Siregar', 'Mahasiswa Sistem Informasi', 'Haloooo Saya mahasiswa Sistem Informasi yang sedang belajar hal baru seputar teknologi dan desain website.', 'Saya adalah mahasiswa Sistem Informasi di Universitas Mulawarman yang memiliki ketertarikan di bidang desain visual dan analisis data. Saya terbiasa menggunakan Figma dan Canva untuk membuat desain, serta Microsoft Excel untuk mengolah data. Saya juga aktif mengikuti kegiatan dan organisasi di lingkungan kampus sebagai bentuk pengembangan diri.', 'assets/foto.jpg');
